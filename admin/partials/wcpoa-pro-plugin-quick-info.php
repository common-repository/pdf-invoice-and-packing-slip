            ...
            <tr>
                ...
                <td class="fr-2">
                    <ul class="help-support">
                        <li><a target="_blank" href="<?php echo esc_url(site_url('wp-admin/admin.php?page=woocommerce_product_attachment_pro&tab=wcpoa-plugin-getting-started')); ?>"><?php esc_html_e('Quick Start Guide', 'woocommerce-product-attachment-'); ?></a></li>
